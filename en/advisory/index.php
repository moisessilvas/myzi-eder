  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p style="text-align: center;">If you want to send a message to us here, please fill out the form below and we will contact you.</p>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Phone number: +55 61 9</h5>
            <p class="card-text">Personal advisor: contato@maikaiconsultoria.com.br</p>
          </div>
        </div>
      </div>
    </div>
