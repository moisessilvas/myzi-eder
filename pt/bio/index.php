  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 sobre-maior" style="background-color: #ffffffe8;">
        ...
        <p>Também em 2016, Mariana foi integrante da Primeira Edição da Academia de Regência da OSESP – Orquestra Sinfônica do Estado de São Paulo – onde trabalhou e regeu durante todo o ano sob a mentoria da maestrina Marin Alsop (titular da OSESP e da Baltimore Symphony Orchestra, EUA).</p>
        ...
        <div class="row justify-content-md-center">
          <div class="col-sm">
            <a class="btn btn-primary btn-block" href="Releasecurto.docx" target="_blank" style="">Pequena Biografia <i class="fas fa-download"></i></a>
          </div>
          <div class="col-sm">
            <a class="btn btn-primary btn-block" href="Releasemedio.docx" target="_blank" style="">Média Biografia <i class="fas fa-download"></i></a>
          </div>
          <div class="col-sm">
            <a class="btn btn-primary btn-block" href="Releasegrande.docx" target="_blank" style="">Grande Biografia <i class="fas fa-download"></i></a>
          </div>
        </div>
        <br>
      </div>
