  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p style="text-align: center;"> Envíe su correo electrónico aquí para recibir nuestras novedades y noticias del blog:</p>
        <form action="insert.php" method="POST">
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Correo</label>
              <input type="email" class="form-control" placeholder="Correo" id="email" required data-validation-required-message="Por favor, preencha o seu endereço de e-mail." name="email">
