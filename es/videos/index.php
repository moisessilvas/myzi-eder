    ...
    <div class="row">
      <div class="col-lg-3 col-md-3 justify-content-md-center">
        <nav class="nav flex-column justify-content-center">
          <a class="text-center nav-link letra" href="../imagenes/">Imágenes</a>
          <b><a class="text-center nav-link letra" href="#">Videos</a></b>
        </nav>
      </div>
      <div class="col-lg-9 col-md-9 mx-auto sobre-maior">
        ...
        <div class="row justify-content-md-center">
          ...
          <div class="col-sm">
            <a class="btn btn-primary btn-block" href="https://m.soundcloud.com/alvarohenrique/bravo-72-190217-mariana-menezes" target="_blank" style="">Escucha aqui <i class="fas fa-podcast"></i></a>
          </div>
          <div class="col-sm"></div>
        </div>
        <br>
        <h2 style="text-align: center; font-family: poppins;">Conciertos</h2><br>
        <div class="row justify-content-md-center col-lg-10 col-md-10 mx-auto">
