            ...
            <div class="p-5">
              ...
              <form action="insert.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" placeholder="Nome do Concerto" name="concerto">
                </div>
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user"  placeholder="Data" name="data">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                ...
                <a href="../concertos" class="btn btn-primary btn-user btn-block">
                  Cancelar
                </a>
              </form>
            </div>
